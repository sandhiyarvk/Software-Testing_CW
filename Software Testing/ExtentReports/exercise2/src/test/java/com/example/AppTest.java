...
public class AppTest {
    ...
    public void mybfre() throws Exception {
        ...
        PropertyConfigurator
                .configure("C:\\Users\\Sneha D\\Downloads\\Testing\\demo\\src\\resources\\log4j.properties");
    ...
    public void Test1() throws Exception {
        ...
        // Assert.assertTrue(check1.getText().contains("chetan bhagat"), "Name not
        // found!");
    ...
    public void Test2() throws InterruptedException {
        ...
        // Thread.sleep(2000);
        // WebElement cart =
        // driver.findElement(By.xpath("//*[@id='add-to-bag-main']/div[1]"));
        // String add = cart.getText();
        // if (add.equals("Item Successfully Added To Your cart")) log.info("TestCase 2
